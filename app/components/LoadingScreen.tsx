...
export default function LoadingScreen({ language }: LoadingScreenProps) {
  ...
  return (
    <div className="rounded-4xl border border-blue-100 bg-linear-to-br from-sky-50 via-white to-cyan-50 p-10 shadow-sm">
      ...
      <p className="mt-5 max-w-3xl text-sm leading-7 text-slate-600">{t.generatingSubtitle}</p>
