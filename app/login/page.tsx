...
function GoogleBadge() {
  return (
    <span className="relative inline-flex h-5 w-5 items-center justify-center rounded-full bg-white shadow-sm">
      <span className="absolute inset-0 rounded-full border border-slate-200" />
      <span className="text-[10px] font-black text-slate-700">G</span>
    </span>
  );
}
