...
const strings: Record<LanguageCode, DashboardStrings> = {
  english: {
    ...
    brand: "Dream Route",
    navigatorTitle: "Interactive Dream Route Navigator",
    ...
    generatingSubtitle: "Dream Route guider is analyzing your path, fees, semester structure, colleges, and salary outlook.",
    ...
    analyzingQuestion: "Analyzing your question with Dream Route guider...",
    askAi: "Ask AI",
    close: "Close",
  },
  hindi: {
